    ...
    >
      <div className="container mx-auto px-4 max-w-[1100px]">
        ...
        <div className="flex justify-center space-x-8">
          ...
          >
            <div className="w-16 h-16 bg-discord bg-contain bg-no-repeat bg-center hover:opacity-80 transition-opacity rounded-full p-2" style={{ backgroundColor: '#5865F2' }}>
          ...
          <a 
            ...
            className="social-icon"
          >
            <div className="w-16 h-16 bg-github bg-contain bg-no-repeat bg-center hover:opacity-80 transition-opacity rounded-full p-3" style={{ backgroundColor: '#333' }}>
